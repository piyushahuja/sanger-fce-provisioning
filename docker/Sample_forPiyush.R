...
png(file=paste0("/home/rstudio/data/FindMarkers/Rplot_UMAP_sample_Signature-",GeneSetName,"_noSCANdata.png"),
...
saveRDS(SEUmac,file="/home/rstudio/data/SEUobj_sample.rds")
